...
export function ReportMetaHeader({ ws, report }: { ws: string; report: ReportDetail }) {
  return (
    <header className="flex flex-col gap-3 border-b border-border pb-5">
      <nav className="flex items-center gap-1.5 text-xs text-muted-foreground">
        <Link to="/w/$ws/reports" params={{ ws }} className="hover:text-foreground hover:underline">
