...
/* Hairline-ruled table with tabular numerals — the briefing's data surface. */
...
>(({ className, ...props }, ref) => (
  <th
    ...
    className={cn(
      ...
      'first:pl-4 last:pr-4 [&:has([role=checkbox])]:pr-0',
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn('px-3 py-2 align-middle text-foreground first:pl-4 last:pr-4', className)}
    {...props}
  />
));
