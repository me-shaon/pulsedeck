...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    data-ring="self"
    className={cn(
      'flex h-8 w-full items-center justify-between gap-2 rounded-md border border-input bg-surface px-2.5 text-sm text-foreground',
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      'relative flex w-full cursor-default select-none items-center rounded-[4px] py-1.5 pl-7 pr-2 text-sm outline-none',
